...
public class Teste_Emissao_Segunda_via_Divida {
	...
	driver.get("https://online.saovicente.sp.gov.br/pmsaovicente/websis/siapegov/arrecadacao/2via/index.php?aba=3");
	...
	WebElement numero = driver.findElement(By.name("inscricaoDIVIDA"));
	numero.isDisplayed();
	numero.isEnabled();
	numero.click();
