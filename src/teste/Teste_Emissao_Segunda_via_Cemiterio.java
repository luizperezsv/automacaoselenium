...
public class Teste_Emissao_Segunda_via_Cemiterio {
	...
	driver.get("https://online.saovicente.sp.gov.br/pmsaovicente/websis/siapegov/arrecadacao/2via/index.php?aba=4");
	
	
	
	
	WebElement numero = driver.findElement(By.name("nome_falecido"));
	numero.isDisplayed();
	numero.isEnabled();
	numero.click();
	...
	WebElement pesquisa = driver.findElement(By.xpath("//*[@id=\"2viaDivida\"]/div/div/form/input[2]"));
